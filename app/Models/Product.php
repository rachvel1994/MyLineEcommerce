...
class Product extends Model implements Commentable
{
    ...
    {
        return $this->hasMany(AccessoryOrderItem::class, 'accessory_order_id', 'order_id');
    }
    ...
    protected static function can(string $abilityPrefix): bool
    {
        return canAbility($abilityPrefix . ':Product');
    }

    public function scopeDeadStock(Builder $query): Builder
    {
        return $query->where('status_id', 4)
            ->where('created_at', '<', now()->subDays(10));
    }

    public function scopeRealStock(Builder $query): Builder
    {
