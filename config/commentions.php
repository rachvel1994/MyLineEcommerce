...
return [
    ...
    */
    'subscriptions' => [
        ...
        'show_subscribers' => env('COMMENTIONS_SUBSCRIPTIONS_SHOW_SUBSCRIBERS', false),
        'show_sidebar' => env('COMMENTIONS_SUBSCRIPTIONS_SHOW_SIDEBAR', false),
        // Automatically subscribe the author when they add a comment
        'auto_subscribe_on_comment' => env('COMMENTIONS_SUBSCRIPTIONS_AUTO_SUBSCRIBE_ON_COMMENT', false),
