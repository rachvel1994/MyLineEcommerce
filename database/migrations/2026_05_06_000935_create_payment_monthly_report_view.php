...
return new class extends Migration {
    public function up(): void
    {
        ...
        DB::statement("
            CREATE SQL SECURITY INVOKER VIEW payment_monthly_report AS
            SELECT
            ...
            JOIN payments ON payments.id = product_payments.payment_id
            JOIN products ON products.id = product_payments.product_id
